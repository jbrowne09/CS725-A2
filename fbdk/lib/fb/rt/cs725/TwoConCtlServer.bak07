...
/** EVENT TOKEN */
 public EventOutput TOKEN = new EventOutput();
/** Initialization Confirm */
 public EventOutput INITO = new EventOutput();
/** Execution Confirmation */
 public EventOutput CNF = new EventOutput();
/** EVENT TOKEN_REQUEST */
 public EventOutput TOKEN_REQUEST = new EventOutput();
/** EVENT TOKEN_RELEASE */
 public EventOutput TOKEN_RELEASE = new EventOutput();
/** {@inheritDoc}
* @param s {@inheritDoc}
* @return {@inheritDoc}
*/
...
*/
  public EventOutput eoNamed(String s){
    ...
    if("TOKEN_REQUEST".equals(s)) return TOKEN_REQUEST;
    if("TOKEN_RELEASE".equals(s)) return TOKEN_RELEASE;
...
/** Connect the given variable to the input variable PE_OUT
  ...
  * @throws FBRManagementException An internal connection failed.
 */
  public void connect_PE_OUT(BOOL newIV) throws FBRManagementException{
    PE_OUT = newIV;
    FC12.connectIVNoException("PE_OUT",PE_OUT);
    }
/** FB FC11 */
...
public TwoConCtlServer(){
    ...
    TOKEN.connectTo(FC12.TOKEN);
    FC12.REQUEST.connectTo(TOKEN_REQUEST);
    FC12.RELEASE.connectTo(TOKEN_RELEASE);
    FC12.connectIVNoException("Block",Block);
    FC12.connectIVNoException("Candidate",Candidate);
    FC12.connectIVNoException("PE",PE);
